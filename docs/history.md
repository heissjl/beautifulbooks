...
**2026-09-25, „/curate seems not be behind any login wall“** (Julian): ohne Cookie abgerufen zeigte die Produktion die Passwortabfrage (`suggest-password` im HTML, keine Entwürfe). Julians Browser trug das 30-Tage-Cookie eines früheren Logins auf `/suggest` oder `/curate`, das für beide gilt. Behoben durch einen „Sign out“-Knopf, lokal geprüft: nach dem Abmelden erscheint das Passwortfeld, „Für Caitlin“ verschwindet.
