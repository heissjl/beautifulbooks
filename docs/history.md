...
Jetzt: „This printing’s ISBN was registered in India; no shop was asked.“ Die Tatsache ist aus der Registrierungsgruppe abgelesen, die Einschränkung verhindert, dass der Satz nach einer Bestandsprüfung klingt (N12). Die Tests prüfen weiter „registered in Turkey“; der Satz wartete bis heute, weil der Branch von 1.11 `lib/linkplan.ts` umbaute. Von 6.27 bleibt der Absatz zum Verfügbarkeits-Button, der erst nach der Entscheidung 0.1 angefasst wird.
