...
| Karten mit Vier-Cover-Mosaik, je Druck eine Kachel, keine Google-Anfrage | 2026-09-06 / 09-07 | F1.3, F4 | Schritt 14, 1.6 | `components/BookGrid.tsx`, `useCardCovers.ts`, `lib/seo.ts` (`coverImages`) |
...
| Ein Fächer aus vier Covern von *Dune* rechts neben der Überschrift, ab `lg`, als Link auf die Wand; die vier aus dem Index nach Abstand gewählt, testgeprüft | 2026-09-10 | F6 | 1.9 | `components/HeroFan.tsx`, `lib/herofan.ts` |
