...
| Sprachreiter brechen auf beiden Geräten um; „All languages" am Ende zeigt die ganze Wand, neuester Druck zuerst; am Telefon ab der siebten Sprache „+n more", „Unknown" und „All languages" nie weggeklappt | 2026-09-11 | F2.4, N14 | 6.8 | `components/CoverGallery.tsx`, `lib/works.ts` (`coversNewestFirst`) |
