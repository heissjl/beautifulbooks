...
- [ ] **5.1 Die Liste der ~500 Werke.** Eine schlichte Liste von Open-Library-Work-IDs. **Der Anfang steht seit dem 2026-09-08**: `data/curated.json` führt hundert Werke, jedes mit einem von Hand gewählten Cover (6.18); die Startseite zeigt achtzehn davon. 5.1 ist die Verlängerung auf rund 500 — für die Sitemap, nicht für die Wand.
