...
- [x] **6.19a Das Mosaik als Ladebild.** *Erledigt 2026-09-09 als MVP (Julian: „die beiden Einwände können wir nach hinten schieben. baue, committe, merge und deploye dann einen mvp und halte in der roadmap fest was er kann und was nicht").*
  ...
  **Was er nicht kann, und was bewusst offen bleibt:**
  ...
  | **Nur die Suche** | Die ersten Sekunden einer Werkseite zeigen weiter `AssemblingWall`. Das Mosaik ersetzt genau eine Stelle. |
