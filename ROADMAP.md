...
- [ ] **6.18 Eine kleine Kuratier-App zum Durchklicken.** (Julian, 2026-09-08: „ich will gute Cover für alle 100 festlegen können, für Lolita z. B. das aus dem Screenshot. Kannst du eine lokale Mini-App erstellen, in der ich mich da schnell durchklicken kann?") Läuft lokal unter `lab/curate/`, wird nie ausgeliefert.
