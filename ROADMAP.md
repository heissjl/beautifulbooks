...
- [ ] **6.18 Eine kleine Kuratier-App zum Durchklicken.** *Gebaut 2026-09-08; am selben Abend um zwei Dinge erweitert: Werke, die der Cover-Index nicht kennt, dürfen dazu (`EXTRA_WORKS`, Cover einmal von Open Library geholt und zwischengespeichert — so kam *The Garden of Eden* mit sieben Covern hinein), und ein Knopf **„aus der Liste streichen"** nimmt ein Buch dauerhaft aus dem Durchlauf und von der Startseite, im Unterschied zu „überspringen", das es für später behält.* (Julian, 2026-09-08: „ich will gute Cover für alle 100 festlegen können, für Lolita z. B. das aus dem Screenshot. Kannst du eine lokale Mini-App erstellen, in der ich mich da schnell durchklicken kann?") Läuft lokal unter `lab/curate/`, wird nie ausgeliefert.
