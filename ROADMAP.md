...
- [x] **1.3 Bild-Cache vor Open Library und Google** (SPEC N8). *Erledigt 2026-09-09 als eigene Route `/img/<S|M|L>/<ol-123|gb-abc>` mit CDN-Cache (30 Tage), nicht als `next/image`-Optimierung.*
