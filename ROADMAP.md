...
| b | **`bb.img` mitlesen** — der CLI geht seit 2026-09-11, aber Hobby hält Logs nur eine Stunde, die Nacht vom 2026-09-10 ist weg. Julian ruft am Telefon eine große Wand auf, Claude liest dabei mit | beide | M7–M9 haben vermutlich eine Ursache: Vercel bekommt Bilder nicht, dann fehlen Kachel *und* Faltung |
...
- [x] **6.33 Die alte pulsierende Wand verschwindet überall.** Erledigt 2026-09-11. `AssemblingWall` ist gelöscht; bis das Mosaik decodiert ist, steht die Überschrift über einer ruhigen Fläche in Mosaikgröße, und kommt es nicht, die Überschrift allein. Julian: **nur** die kleine Wand war gemeint, die übrigen Pulse bleiben. Kein Vorladen auf jeder Seite — das hätte jeden Besuch rund 90 KB gekostet. → [Historie](docs/history.md#2026-09-11--vier-befunde-vom-telefon-behoben-roadmap-630-bis-633) · [Archiv](docs/roadmap-archive.md#633)
