...
- **Neu am 2026-09-11: 5.8a, Hot or Not online als Preview mit Speicher — lokal fertig** (`/versus`, SPEC F7). Wartet auf Julian: den Upstash-Speicher mit Präfix `STORAGE` nur an die Preview-Umgebung hängen, dann den Push des Branches freigeben. Den Freigabe-Link für die Freunde erzeugt danach Claude über den Vercel-Connector; die Previews bleiben geschützt.
