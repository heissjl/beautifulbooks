...
- **53 Punkte offen, 36 erledigt.** Phase 1 ist bis auf Julians Stichprobe (1.8) leer, Phase 2 hat nur noch Julians Konten und die Abnahme. Der größte offene Block ist Phase 6, und dort zuerst die Fehler, die ein Leser sieht.
...
| 5 | **6.5** Kleinigkeiten: Tippfehler-Toleranz, Label „about this book“, ein Weg aus der Telefon-Schublade zurück zur Wand, `priority` auf den ersten Kacheln (Mosaik-Ausfall und 6.8 erledigt 2026-09-11) | Claude | je etwa eine Stunde | ohne Abhängigkeit; `priority` vorher neu messen, 1.3 hat es verschoben |
...
| | Was | Wer | Befund |
|---|---|---|---|
| a | ~~**6.25a deployen**~~ — in Produktion seit 2026-09-11 | — | M6: die Wand übernimmt fast leer |
...
| [6 Qualität](#phase-6--qualität-jederzeit-dazwischen) | Fehler, Daten, Oberfläche, Startseite | 19 | 17 | teils 6.6 (Geld), teils 6.18 (Julian) |
