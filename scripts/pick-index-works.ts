...
const SEEDS: Array<[title: string, author: string]> = [
  ...
  // Vierte Runde, 2026-09-26 (ROADMAP 5.8a): noch einmal rund 250 Bücher,
  // damit das Cover-Spiel auf 2000 Cover wächst, ohne dass ein Buch mehr als
  // fünf Designs bringt (Julian: "add another 1000 covers"). Weltliteratur
  // nach Sprachen, englische und amerikanische Klassiker, Genre, BookTok,
  // Kinderbuch, Sachbuch, Theater und Lyrik. Gelaufen mit --target=500: die
  // Liste war bei The Borrowers voll, alles danach wartet auf eine nächste
  // Runde. Crime and Punishment (19 Ausgaben) und Don Quixote (2) fanden
  // wieder nur ein zu kleines Werk.
  ['Crime and Punishment', 'Fyodor Dostoevsky'],
  ['Don Quixote', 'Miguel de Cervantes'],
  ['The Iliad', 'Homer'],
  ['The Aeneid', 'Virgil'],
  ...
  ['Rubáiyát of Omar Khayyám', 'Omar Khayyam'],
