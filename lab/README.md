...
| `loading/` | Can the mosaic be the search's loading screen — assembled in front of the reader, out of one file? Four animations, measured. | 6.19a | **four proposals built** 2026-09-09, the choice is Julian's; see [loading/README.md](loading/README.md) |
