...
- **Ein gefaltetes Cover muss erreichbar bleiben.** Die Kachel des Vertreters trägt „+N"; über diese Zahl müssen die gefalteten Bilder anzusehen sein. *Heute nicht der Fall: das Abzeichen ist nicht anklickbar, und ein Link auf ein gefaltetes Cover löst auf den Vertreter auf — das Bild ist nirgends zu sehen (ROADMAP 6.13).* Das ist derselbe Gedanke wie E16: ein Fehlurteil beim Falten soll eine Position kosten, kein Cover.
...
| E12 | 2026-09-07 | Verfügbarkeits-Button | Bleibt vorerst drin; **nicht für den Betrieb freigegeben**, Entscheidung vor dem ersten Deployment (ROADMAP). |
