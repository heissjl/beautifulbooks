...
- **Der Ladetext steht über dem Bild, nicht darauf.** (Julian, 2026-09-09: „beim lademosaik sollte der ladetext grafisch über dem mosaik stehen, nicht als overlay.") Beide Wartebilder — der Cover-Fächer (`LoadingStage`) und die sich bauende Wand (`AssemblingWall`) — tragen die Zeile jetzt **oberhalb** und **im Textfluss**. Vorher hing sie im Fächer absolut am unteren Rand der Bühne und kreuzte auf schmalen Schirmen die Cover. Der Grund ist nicht nur Ästhetik: eine Zeile Text über einem Bild liest sich als **Bildunterschrift dazu**, und genau das darf dieser Satz nicht sein — er sagt, worauf gewartet wird, nicht, was zu sehen ist (N12, und derselbe Gedanke wie N13).
