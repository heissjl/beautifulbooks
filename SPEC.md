...
**Die Ausgaben unter einem gefalteten Cover** sind nach demselben Kriterium sortiert (`orderEditionsForMarket`): ISBN aus dem Sprachraum des Marktes zuerst, dann irgendeine ISBN, dann das jüngste Jahr. Vorher war es die Ankunftsreihenfolge von Open Library, also das Alter des Datensatzes.
