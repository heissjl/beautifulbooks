...
- **F2.4 Sprach-Tabs.** Cover gruppiert nach Sprache der Ausgaben, die sie tragen. Reihenfolge: die im Suchfilter gewählte Sprache zuerst, dann Englisch, dann Deutsch (`LEAD_LANGUAGES`), dann nach Häufigkeit, „Unknown“ zuletzt. Die Ladeszene wartet, bis die gewünschte Sprache (sonst Englisch) da ist, längstens bis 300 Ausgaben geprüft sind, damit die vorderen Reiter nicht unter dem Mauszeiger nachrücken. Unterhalb von `sm` stehen die Reiter in einer seitlich scrollbaren Zeile. **Als letzter Reiter steht „All languages“** (seit 2026-09-11, ROADMAP 6.8): die ganze Wand in der Ordnung von F2.5, nur wenn es mehr als eine Sprache gibt. Er ist nie vorausgewählt — vorne würde er die Reihenfolge dieses Absatzes aushebeln — und steht nicht in der URL, weil `?lang=` dort der Suchfilter ist.
